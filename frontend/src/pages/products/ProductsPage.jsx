  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">{t('products')} Catalog</h2>
      ...
      {/* Filter & Search Bar */}
      <div className="bg-white p-3 sm:p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-3 items-center justify-between">
        {/* Search */}
                ...
                products.map((p) => {
                  ...
                  return (
                    <tr key={p._id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="p-3.5 text-center font-extrabold text-slate-800 whitespace-nowrap">
